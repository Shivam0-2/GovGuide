GovGuide – Requirements Document

1. Objective
GovGuide is an AI-powered platform designed to improve access to public welfare by helping citizens discover and understand the government schemes they are eligible for. It bridges complex policy information with simple, personalized guidance.

2. Stakeholders
Primary Users:
Farmers, students, senior citizens, job seekers, and other individuals seeking benefits.

Assisted Users:
NGO volunteers and Common Service Centre (CSC) operators supporting citizens.

3. Problem – The Discovery Gap
